...
public class VisitorPatternDemoApplication {
    ...
    public static void main(String[] args) {
        ...
        var describer = new Visitor<String>() {
        ...
        String visited = toyota.accept(describer, Collectors.joining("---"));
        System.out.println("Visited = " + visited);

        List<String> descriptions = toyota.accept(describer, Collectors.toList());
        descriptions.forEach(System.out::println);

        int total = toyota.accept(new PriceVisitor(), Collectors.summingInt(Integer::intValue));
